            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="auth-logo">
                        <h3 class="text-center">
                            <a href="index.html" class="logo d-block my-4">
                                <img src="{{ asset('admin-assets') }}/images/logo-dark.png" class="logo-dark mx-auto" height="120" alt="logo-dark">
                            </a>
                        </h3>
                    </div>
                    ...
                    <div class="p-3">
                        ...
                        <p class="text-muted text-center">Sign in to MyAIBotix Admin Panel</p>
